...
percent_overweight_and_obesity_by_sex_2018 <- rbind(
...
percent_overweight_or_obese_by_age_and_sex_2022 <- rbind(
  percent_overweight_or_obese_by_age_and_sex_2022_male,
...
BMI_data <- rbind(
  percent_overweight_and_obesity_by_sex_2015,
