...
BMI_cust <- as.data.frame(matrix(
  c(
    "c1", coefficent_mod_values$Mod_value[which(coefficent_mod_values$Variable_label == "c1")],
...
OA_cust <- as.data.frame(matrix(
  c(
    "c6_cons", coefficent_mod_values$Mod_value[which(coefficent_mod_values$Variable_label == "c6_cons")],
...
current.TKR.mod.values <- c(
  1, # modification for c9_age
  ...
  1
) # modification for c9_cons

TKR_cust <- as.data.frame(matrix(
  c(
    "c9_age", coefficent_mod_values$Mod_value[which(coefficent_mod_values$Variable_label == "c9_age")],
