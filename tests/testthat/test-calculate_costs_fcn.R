...
test_that("calculate_costs_fcn calculates costs correctly", {
  ...
  # 3. Assertions
  # Person 1: Primary TKA + Rehab + OA management + Comorbidity
  expect_equal(result$cycle_cost_healthcare[1], 18000 + 4500 + 800 + 10)
  expect_equal(result$cycle_cost_patient[1], 2000 + 500 + 200)
  expect_equal(result$cycle_cost_societal[1], 2500 + 1800)
  expect_equal(result$cycle_cost_total[1], (18000 + 4500 + 800 + 10) + (2000 + 500 + 200) + (2500 + 1800))

  # Person 2: OA management only + Comorbidity
  expect_equal(result$cycle_cost_healthcare[2], 800 + 20)
  expect_equal(result$cycle_cost_patient[2], 200)
  expect_equal(result$cycle_cost_societal[2], 2500 + 1800)
  expect_equal(result$cycle_cost_total[2], (800 + 20) + 200 + (2500 + 1800))

  # Person 3: Revision TKA + Rehab + OA management + Comorbidity
  expect_equal(result$cycle_cost_healthcare[3], 27000 + 4500 + 800 + 30)
  expect_equal(result$cycle_cost_patient[3], 3000 + 500 + 200)
  expect_equal(result$cycle_cost_societal[3], 2500 + 1800)
  expect_equal(result$cycle_cost_total[3], (27000 + 4500 + 800 + 30) + (3000 + 500 + 200) + (2500 + 1800))

  # Person 4: No OA, no events, but has comorbidity cost
  expect_equal(result$cycle_cost_healthcare[4], 40)
  expect_equal(result$cycle_cost_patient[4], 0)
  expect_equal(result$cycle_cost_societal[4], 0)
  expect_equal(result$cycle_cost_total[4], 40)


  # Person 5: Primary TKA + Complication + OA management + Comorbidity
  expect_equal(result$cycle_cost_healthcare[5], 18000 + 800 + 5000 + 50)
